...
## Problem  : Write an if/else statement to print if a number is odd or even.


## Problem  : Use your if/else statement with a for loop to print "odd" or "even" for every item in list_2


## Problem  :  Create a dictionary containing key value pairs for your name, email address, and any other pertinent information


## Problem  : Print every number between 0 and 100


## Problem  : Write a function that prints every number up to a given input
